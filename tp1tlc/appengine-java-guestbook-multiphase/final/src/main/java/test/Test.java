...
//			in.close();
			...
			Process p = r.exec("curl -H 'Content-Type: application/json' -X GET "+"http://127.0.0.1:8080/sign?title=PetiteAnnonce"+i+"&price="+i+"&date="+URLEncoder.encode(ndate.toString(), "UTF-8"));p.waitFor();
